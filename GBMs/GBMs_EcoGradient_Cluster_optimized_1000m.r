...
setwd("E:/D17_GIS/PAPER_1_ANALYSIS/GBMs/ArcJoin")
...
res <- 1000 # The resolution of the study cells (to select the correc???t csv file, and to label outputs)
dfAll <- read.csv(sprintf("E:/D17_GIS/PAPER_1_ANALYSIS/GBMs/ArcJoin/D17_%sm.csv", res))
