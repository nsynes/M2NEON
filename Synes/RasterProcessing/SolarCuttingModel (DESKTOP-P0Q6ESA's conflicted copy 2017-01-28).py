...
pthSensorShape = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SensorPoints\SensorCircle_Radius%sm.shp" %buffRad
...
pthDEMsf = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\RASTER\DEM\SJER_DEM_2m.tif"
pthDEMsm = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\RASTER\DEM\TEAK_DEM_2m.tif"
pthDSMsf = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\RASTER\DSM\SJER_DSM_2m.tif"
pthDSMsm = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\RASTER\DSM\TEAK_DSM_2m.tif"
pthSensorLyr = "SensorCircleLyr"
dirTemp = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\temp"

dirSolarDays = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\SolarDays"
dirRaster = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\RASTER"
pthSensorPoints = r"C:\Dropbox (ASU)\M2NEON\DGPS\CleanedLinked\SJER_TEAK_Sensors.shp"
pthSensorPointLyr = "SensorPointLyr"

if not os.path.exists(dirSolarDays):
            os.mkdir(dirSolarDays)

dfTransSF = pandas.read_csv(r"C:\Dropbox (ASU)\M2NEON\Paper_2\ANALYSIS\AtmosphericTransmittance\SJER_2013.csv", index_col="yday")
dfTransSM = pandas.read_csv(r"C:\Dropbox (ASU)\M2NEON\Paper_2\ANALYSIS\AtmosphericTransmittance\TEAK_2013.csv", index_col="yday")
...
for row in sorted(arcpy.da.SearchCursor(pthSensorLyr, fields)):
    ...
    if locID[-1] == "0":
        ...
        for day in range(1, MaxDay + 1):
            ...
            arcpy.sa.PointsSolarRadiation(pthNewDSM, pthSensorPoints, pthOutShp, height,
                                 latitude, skySize, 
