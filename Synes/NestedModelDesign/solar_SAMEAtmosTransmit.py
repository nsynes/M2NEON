...
for scale in ["Microsite","Site"]:
    for Site in ["SJER","TEAK"]:
        ...
        if scale == "Microsite":
            dirOut = r"D:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\MicrositeLevel_PointBasedSolar_SAMEAtmosTrans\Solar%s_%s" %(Site, RasterModel)
        elif scale == "Site":
            dirOut = r"D:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SiteLevel_PointBasedSolar_SAMEAtmosTrans\Solar%s_%s" %(Site, RasterModel)
        ...
        for day in range(1,366):
            ...
            diffuseProp = 0.3
            transmittivity = 0.5 #df["G/H0"][day]
...
Site = "SJER"
dirOut = r"D:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SiteLevel_PointBasedSolar_SAMEAtmosTrans\Solar%s_%s" %(Site, RasterModel)
pthLocation = r"D:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SensorPoints\%s_SiteLevel.shp" %(Site)


print "Joining loc_ID or site_ID to solar data"
print Site
for day in range(1,366):
    print day
