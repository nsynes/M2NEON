...
pthPoints = r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SensorPoints\SJER_TEAK_Sensors.shp"
...
arcpy.CopyFeatures_management(buffs, r"C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SensorPoints\Circle_Radius2_5m.shp") # %buffRad)
arcpy.JoinField_management ("C:\Dropbox (ASU)\M2NEON\Paper_2\DATA\VECTOR\SensorPoints\Circle_Radius2_5m.shp","FID", # %buffRad, "FID",
